package com.flashflexpro.graniteamf;
 ...
 * Time: 1:38 PM
 */
public class SimpleAMF3Serializer extends AMF3Serializer{
    public SimpleAMF3Serializer(OutputStream out ){
        super( out );
    }

    public SimpleAMF3Serializer(OutputStream out, int capacity ){
        super( out, capacity );
    }
